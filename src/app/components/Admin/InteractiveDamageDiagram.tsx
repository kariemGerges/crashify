...
//     // Left side zones
//     {
//         zoneId: 'LV_SUV_L_DOR_F',
//         position: [-0.45, 0.1, 0.1],
//         size: [0.15, 0.3, 0.25],
//     },
//     {
//         zoneId: 'LV_SUV_L_DOR_R',
//         position: [-0.45, 0.1, -0.1],
//         size: [0.15, 0.3, 0.25],
//     },
...
//     // Right side zones
//     {
//         zoneId: 'LV_SUV_R_DOR_F',
//         position: [0.45, 0.1, 0.1],
//         size: [0.15, 0.3, 0.25],
//     },
//     {
//         zoneId: 'LV_SUV_R_DOR_R',
//         position: [0.45, 0.1, -0.1],
//         size: [0.15, 0.3, 0.25],
//     },
...
//                 {/* Front face */}
//                 <mesh
//                     position={[0, 0, carLength / 2 + 0.001]}
...
//                 {/* Top face */}
//                 <mesh
//                     position={[0, carHeight / 2 + 0.001, 0]}
...
//                                     3D Interactive View - Drag to rotate, scroll
//                                     to zoom
//                                 </h4>
...
const ZONE_PATHS: Record<string, ZonePath> = {
    // FRONT VIEW - Adjusted to be more centered and match typical car proportions
    LV_SUV_F_BAR_FRT: {
        view: 'FRT',
        path: 'M 20 85 L 80 85 L 80 95 L 20 95 Z',
        bounds: { x: 20, y: 85, width: 60, height: 10 },
    },
    LV_SUV_BON_FRT: {
        view: 'FRT',
        path: 'M 25 50 L 75 50 L 73 70 L 27 70 Z',
        bounds: { x: 25, y: 50, width: 50, height: 20 },
    },
    LV_SUV_F_GLS_FRT: {
        view: 'FRT',
        path: 'M 20 20 L 80 20 L 78 45 L 22 45 Z',
        bounds: { x: 20, y: 20, width: 60, height: 25 },
    },
    LV_SUV_L_FDR_FRT: {
        view: 'FRT',
        path: 'M 10 50 L 25 50 L 25 75 L 10 75 Z',
        bounds: { x: 10, y: 50, width: 15, height: 25 },
    },
    LV_SUV_R_FDR_FRT: {
        view: 'FRT',
        path: 'M 75 50 L 90 50 L 90 75 L 75 75 Z',
        bounds: { x: 75, y: 50, width: 15, height: 25 },
    },

    // REAR VIEW - Adjusted to be more centered
    LV_SUV_R_BAR_REA: {
        view: 'REA',
        path: 'M 20 5 L 80 5 L 80 15 L 20 15 Z',
        bounds: { x: 20, y: 5, width: 60, height: 10 },
    },
    LV_SUV_BOOT_REA: {
        view: 'REA',
        path: 'M 25 15 L 75 15 L 75 50 L 25 50 Z',
        bounds: { x: 25, y: 15, width: 50, height: 35 },
    },
    LV_SUV_R_GLS_REA: {
        view: 'REA',
        path: 'M 22 20 L 78 20 L 76 40 L 24 40 Z',
        bounds: { x: 22, y: 20, width: 56, height: 20 },
    },
    LV_SUV_L_QTR_REA: {
        view: 'REA',
        path: 'M 10 25 L 25 25 L 25 55 L 10 55 Z',
        bounds: { x: 10, y: 25, width: 15, height: 30 },
    },
    LV_SUV_R_QTR_REA: {
        view: 'REA',
        path: 'M 75 25 L 90 25 L 90 55 L 75 55 Z',
        bounds: { x: 75, y: 25, width: 15, height: 30 },
    },

    // LEFT SIDE VIEW - Adjusted to be more centered horizontally
    LV_SUV_L_FDR_LHS: {
        view: 'LHS',
        path: 'M 10 25 L 25 25 L 25 45 L 10 45 Z',
        bounds: { x: 10, y: 25, width: 15, height: 20 },
    },
    LV_SUV_L_DOR_F_LHS: {
        view: 'LHS',
        path: 'M 10 45 L 25 45 L 25 65 L 10 65 Z',
        bounds: { x: 10, y: 45, width: 15, height: 20 },
    },
    LV_SUV_L_DOR_R_LHS: {
        view: 'LHS',
        path: 'M 10 65 L 25 65 L 25 85 L 10 85 Z',
        bounds: { x: 10, y: 65, width: 15, height: 20 },
    },
    LV_SUV_L_QTR_LHS: {
        view: 'LHS',
        path: 'M 10 85 L 25 85 L 25 95 L 10 95 Z',
        bounds: { x: 10, y: 85, width: 15, height: 10 },
    },

    // RIGHT SIDE VIEW - Adjusted to be more centered horizontally
    LV_SUV_R_FDR_RHS: {
        view: 'RHS',
        path: 'M 75 25 L 90 25 L 90 45 L 75 45 Z',
        bounds: { x: 75, y: 25, width: 15, height: 20 },
    },
    LV_SUV_R_DOR_F_RHS: {
        view: 'RHS',
        path: 'M 75 45 L 90 45 L 90 65 L 75 65 Z',
        bounds: { x: 75, y: 45, width: 15, height: 20 },
    },
    LV_SUV_R_DOR_R_RHS: {
        view: 'RHS',
        path: 'M 75 65 L 90 65 L 90 85 L 75 85 Z',
        bounds: { x: 75, y: 65, width: 15, height: 20 },
    },
    LV_SUV_R_QTR_RHS: {
        view: 'RHS',
        path: 'M 75 85 L 90 85 L 90 95 L 75 95 Z',
        bounds: { x: 75, y: 85, width: 15, height: 10 },
    },

    // TOP VIEW - Adjusted to be more centered
    LV_SUV_ROF_TOP: {
        view: 'TOP',
        path: 'M 25 30 L 75 30 L 75 70 L 25 70 Z',
...
const ZONE_3D_POSITIONS: Zone3DPosition[] = [
    { zoneId: 'LV_SUV_F_BAR', position: [0, 0.05, 1.02], size: [0.85, 0.15, 0.08] },
    { zoneId: 'LV_SUV_BON', position: [0, 0.28, 0.75], size: [0.88, 0.08, 0.5] },
    { zoneId: 'LV_SUV_F_GLS', position: [0, 0.48, 0.45], size: [0.8, 0.3, 0.05] },
    { zoneId: 'LV_SUV_L_FDR', position: [-0.45, 0.15, 0.5], size: [0.1, 0.3, 0.4] },
    { zoneId: 'LV_SUV_R_FDR', position: [0.45, 0.15, 0.5], size: [0.1, 0.3, 0.4] },
    { zoneId: 'LV_SUV_R_BAR', position: [0, 0.05, -1.02], size: [0.85, 0.15, 0.08] },
    { zoneId: 'LV_SUV_BOOT', position: [0, 0.25, -0.75], size: [0.85, 0.3, 0.5] },
    { zoneId: 'LV_SUV_R_GLS', position: [0, 0.45, -0.7], size: [0.8, 0.28, 0.05] },
    { zoneId: 'LV_SUV_L_QTR', position: [-0.45, 0.15, -0.65], size: [0.1, 0.3, 0.4] },
    { zoneId: 'LV_SUV_R_QTR', position: [0.45, 0.15, -0.65], size: [0.1, 0.3, 0.4] },
    { zoneId: 'LV_SUV_L_DOR_F', position: [-0.455, 0.25, 0.3], size: [0.02, 0.35, 0.55] },
    { zoneId: 'LV_SUV_L_DOR_R', position: [-0.455, 0.25, -0.35], size: [0.02, 0.35, 0.6] },
    { zoneId: 'LV_SUV_R_DOR_F', position: [0.455, 0.25, 0.3], size: [0.02, 0.35, 0.55] },
    { zoneId: 'LV_SUV_R_DOR_R', position: [0.455, 0.25, -0.35], size: [0.02, 0.35, 0.6] },
    { zoneId: 'LV_SUV_ROF', position: [0, 0.58, -0.05], size: [0.84, 0.04, 1.2] },
];

// 3D Car Component with realistic SUV model
const Car3D: React.FC<{
    damageEntries: DamageEntry[];
    selectedZone: string | null;
    hoveredZone: string | null;
    ...
    // Professional color palette - Modern SUV design
    // Primary: Sophisticated pearl white with blue-gray undertones
    const carPaint = '#f8f9fa'; // Soft pearl white
    const carPaintSecondary = '#e9ecef'; // Slightly darker for depth
    const carAccent = '#212529'; // Deep charcoal for contrast
    const carMetal = '#0d1117'; // Near-black for trim
    const chrome = '#cbd5e1'; // Polished chrome
    const chromeDark = '#94a3b8'; // Darker chrome accents
    
    // Professional PBR materials - Realistic car paint
    ...
    const paintSecondaryMaterial = new THREE.MeshPhysicalMaterial({
        color: carPaintSecondary,
        metalness: 0.08,
        roughness: 0.35,
        clearcoat: 0.95,
    ...
    const chromeDarkMaterial = new THREE.MeshStandardMaterial({
        color: chromeDark,
        metalness: 0.95,
        roughness: 0.1,
    });

    // Professional glass material - Realistic automotive glass
    ...
    // Professional rim material - Brushed aluminum
    ...
    return (
        <group position={[0, -0.15, 0]}>
            {/* Main body - Recognizable SUV proportions (taller, boxier) */}
            <RoundedBox
                position={[0, 0.25, 0]}
                args={[1.0, 0.38, 2.3]}
                radius={0.05}
            ...
            {/* Upper cabin - Taller, more vertical SUV cabin */}
            <RoundedBox
                position={[0, 0.58, -0.1]}
                args={[0.95, 0.48, 1.55]}
                radius={0.04}
            ...
            {/* Body side character lines - SUV styling */}
            <mesh position={[-0.5, 0.32, 0]} castShadow>
                <boxGeometry args={[0.01, 0.018, 2.1]} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            <mesh position={[0.5, 0.32, 0]} castShadow>
                <boxGeometry args={[0.01, 0.018, 2.1]} />
                <primitive object={chromeDarkMaterial} attach="material" />
            ...
            {/* Lower body cladding - SUV characteristic */}
            <mesh position={[0, 0.08, 0]} castShadow>
                <RoundedBox args={[1.02, 0.12, 2.32]} radius={0.03} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.5} />
            </mesh>

            {/* Windshield - SUV style (more vertical) */}
            <mesh position={[0, 0.68, 0.58]} rotation={[-0.18, 0, 0]} castShadow>
                <RoundedBox args={[0.91, 0.42, 0.05]} radius={0.015} smoothness={3} />
                <primitive object={glassMaterial} attach="material" />
            </mesh>
            
            {/* Windshield frame - Black trim */}
            <mesh position={[0, 0.68, 0.58]} rotation={[-0.18, 0, 0]} castShadow>
                <RoundedBox args={[0.93, 0.44, 0.06]} radius={0.018} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.4} />
            </mesh>

            {/* Rear window - SUV style (more vertical) */}
            <mesh position={[0, 0.65, -0.88]} rotation={[0.15, 0, 0]} castShadow>
                <RoundedBox args={[0.91, 0.4, 0.05]} radius={0.015} smoothness={3} />
                <primitive object={glassMaterial} attach="material" />
            </mesh>
            
            {/* Rear window frame */}
            <mesh position={[0, 0.65, -0.88]} rotation={[0.15, 0, 0]} castShadow>
                <RoundedBox args={[0.93, 0.42, 0.06]} radius={0.018} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.4} />
            </mesh>

            {/* Side windows - Tall SUV windows */}
            {/* Left front window */}
            <mesh position={[-0.48, 0.6, 0.24]} rotation={[0, 0, 0.01]} castShadow>
                <RoundedBox args={[0.05, 0.4, 0.75]} radius={0.008} smoothness={3} />
                <primitive object={glassMaterial} attach="material" />
            </mesh>
            {/* Left front window frame */}
            <mesh position={[-0.48, 0.6, 0.24]} rotation={[0, 0, 0.01]} castShadow>
                <RoundedBox args={[0.06, 0.42, 0.77]} radius={0.01} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.4} />
            </mesh>
            
            {/* Left rear window */}
            <mesh position={[-0.48, 0.6, -0.45]} rotation={[0, 0, 0.01]} castShadow>
                <RoundedBox args={[0.05, 0.4, 0.68]} radius={0.008} smoothness={3} />
                <primitive object={glassMaterial} attach="material" />
            </mesh>
            {/* Left rear window frame */}
            <mesh position={[-0.48, 0.6, -0.45]} rotation={[0, 0, 0.01]} castShadow>
                <RoundedBox args={[0.06, 0.42, 0.7]} radius={0.01} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.4} />
            </mesh>
            ...
            {/* Right rear window frame */}
            <mesh position={[0.48, 0.6, -0.45]} rotation={[0, 0, -0.01]} castShadow>
                <RoundedBox args={[0.06, 0.42, 0.7]} radius={0.01} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.4} />
            </mesh>

            {/* Hood - SUV style (flatter, more horizontal) */}
            <mesh position={[0, 0.44, 0.92]} rotation={[-0.08, 0, 0]} castShadow receiveShadow>
                <RoundedBox args={[0.96, 0.16, 0.65]} radius={0.04} smoothness={4} />
                <primitive object={paintMaterial} attach="material" />
            </mesh>
            
            {/* Hood power dome - SUV characteristic */}
            <mesh position={[0, 0.46, 0.92]} rotation={[-0.08, 0, 0]} castShadow>
                <RoundedBox args={[0.4, 0.02, 0.5]} radius={0.02} smoothness={3} />
                <meshStandardMaterial color={carPaintSecondary} metalness={0.15} roughness={0.4} />
            </mesh>

            {/* Front grille - Professional design with refined details */}
            <mesh position={[0, 0.28, 1.1]} castShadow receiveShadow>
                <RoundedBox args={[0.74, 0.24, 0.06]} radius={0.025} smoothness={4} />
                <primitive object={trimMaterial} attach="material" />
            </mesh>
            
            {/* Grille mesh pattern - Professional horizontal bars */}
            {Array.from({ length: 5 }).map((_, i) => (
                <mesh key={i} position={[0, 0.28 - (i * 0.038), 1.13]} castShadow>
                    <boxGeometry args={[0.68, 0.012, 0.015]} />
                    <meshStandardMaterial color="#050505" metalness={0.85} roughness={0.25} />
                </mesh>
            ))}
            
            {/* Grille vertical accents */}
            {Array.from({ length: 3 }).map((_, i) => (
                <mesh key={`vert-${i}`} position={[-0.2 + (i * 0.2), 0.28, 1.13]} castShadow>
                    <boxGeometry args={[0.008, 0.22, 0.015]} />
                    <meshStandardMaterial color="#0a0a0a" metalness={0.8} roughness={0.3} />
                </mesh>
            ))}
            
            {/* Grille badge/logo area - Refined design */}
            <mesh position={[0, 0.3, 1.13]} castShadow>
                <RoundedBox args={[0.14, 0.1, 0.018]} radius={0.012} smoothness={3} />
                <primitive object={chromeMaterial} attach="material" />
            </mesh>

            {/* Front bumper - Professional design */}
            <mesh position={[0, 0.14, 1.1]} castShadow receiveShadow>
                <RoundedBox args={[0.94, 0.26, 0.12]} radius={0.045} smoothness={4} />
                <primitive object={trimMaterial} attach="material" />
            </mesh>
            
            {/* Front bumper lower section - Air dam */}
            <mesh position={[0, 0.06, 1.1]} castShadow receiveShadow>
                <RoundedBox args={[0.96, 0.1, 0.14]} radius={0.02} smoothness={3} />
                <meshStandardMaterial color="#050505" metalness={0.5} roughness={0.6} />
            </mesh>
            
            {/* Front bumper accent line */}
            <mesh position={[0, 0.18, 1.1]} castShadow>
                <boxGeometry args={[0.92, 0.004, 0.12]} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>

            {/* Rear bumper - Professional design */}
            <mesh position={[0, 0.14, -1.1]} castShadow receiveShadow>
                <RoundedBox args={[0.94, 0.26, 0.12]} radius={0.045} smoothness={4} />
                <primitive object={trimMaterial} attach="material" />
            </mesh>
            ...
            {/* Roof - SUV style (larger, flatter) */}
            <mesh position={[0, 0.78, -0.05]} castShadow receiveShadow>
                <RoundedBox args={[0.94, 0.08, 1.42]} radius={0.03} smoothness={4} />
                <primitive object={paintMaterial} attach="material" />
            </mesh>
            
            {/* Roof rack base plates - SUV feature */}
            <mesh position={[-0.42, 0.8, 0.3]} castShadow>
                <RoundedBox args={[0.08, 0.02, 0.12]} radius={0.01} smoothness={2} />
                <meshStandardMaterial color={carMetal} metalness={0.7} roughness={0.4} />
            </mesh>
            <mesh position={[0.42, 0.8, 0.3]} castShadow>
                <RoundedBox args={[0.08, 0.02, 0.12]} radius={0.01} smoothness={2} />
                <meshStandardMaterial color={carMetal} metalness={0.7} roughness={0.4} />
            </mesh>
            <mesh position={[-0.42, 0.8, -0.4]} castShadow>
                <RoundedBox args={[0.08, 0.02, 0.12]} radius={0.01} smoothness={2} />
                <meshStandardMaterial color={carMetal} metalness={0.7} roughness={0.4} />
            </mesh>
            <mesh position={[0.42, 0.8, -0.4]} castShadow>
            ...
            {/* SUV side mirrors - Larger, more prominent */}
            {/* Left mirror housing */}
            <mesh position={[-0.52, 0.66, 0.38]} rotation={[0, 0.22, 0]} castShadow>
                <RoundedBox args={[0.12, 0.1, 0.18]} radius={0.025} smoothness={3} />
                <primitive object={paintMaterial} attach="material" />
            </mesh>
            {/* Left mirror glass */}
            <mesh position={[-0.52, 0.66, 0.42]} rotation={[0, 0.22, 0]} castShadow>
                <RoundedBox args={[0.1, 0.08, 0.02]} radius={0.012} smoothness={3} />
                <meshStandardMaterial 
                    color="#1a2332" 
                    metalness={0.95}
                    roughness={0.05}
            ...
            {/* Left mirror base */}
            <mesh position={[-0.51, 0.6, 0.35]} castShadow>
                <RoundedBox args={[0.05, 0.08, 0.05]} radius={0.015} smoothness={3} />
                <primitive object={paintMaterial} attach="material" />
            </mesh>
            {/* Left mirror indicator */}
            <mesh position={[-0.52, 0.64, 0.42]} rotation={[0, 0.22, 0]} castShadow>
                <RoundedBox args={[0.06, 0.015, 0.015]} radius={0.005} smoothness={2} />
            ...
            {/* Door handles - Professional flush design */}
            {/* Left front door handle */}
            <mesh position={[-0.48, 0.4, 0.26]} castShadow>
                <RoundedBox args={[0.032, 0.045, 0.13]} radius={0.012} smoothness={3} />
                <primitive object={chromeMaterial} attach="material" />
            </mesh>
            {/* Left rear door handle */}
            <mesh position={[-0.48, 0.4, -0.28]} castShadow>
                <RoundedBox args={[0.032, 0.045, 0.13]} radius={0.012} smoothness={3} />
                <primitive object={chromeMaterial} attach="material" />
            </mesh>
            ...
            {/* SUV wheels - Larger, higher ground clearance */}
            {[
                [-0.48, 0.18, 0.78],
                [0.48, 0.18, 0.78],
                [-0.48, 0.18, -0.78],
                ...
                <group key={i} position={pos as [number, number, number]}>
                    ...
                    <mesh rotation={[0, 0, Math.PI / 2]} castShadow>
                        <cylinderGeometry args={[0.21, 0.21, 0.19, 36]} />
                        <primitive object={tireMaterial} attach="material" />
                    </mesh>
                    {/* Tire tread pattern */}
                    <mesh rotation={[0, 0, Math.PI / 2]} position={[0, 0, 0.095]} castShadow>
                        <torusGeometry args={[0.21, 0.01, 16, 36]} />
                    ...
                    {/* Rim detail ring */}
                    <mesh rotation={[0, 0, Math.PI / 2]} castShadow>
                        <cylinderGeometry args={[0.14, 0.14, 0.21, 32]} />
                        <primitive object={chromeDarkMaterial} attach="material" />
                    </mesh>
                    ...
                    {/* 6-spoke design (SUV style) */}
                    {Array.from({ length: 6 }).map((_, j) => (
                        <mesh
                            key={j}
                            rotation={[0, 0, (Math.PI / 2) + (j * (Math.PI * 2) / 6)]}
                            position={[0, 0, 0.1]}
                        >
                            <boxGeometry args={[0.016, 0.14, 0.016]} />
                            <primitive object={chromeMaterial} attach="material" />
                        </mesh>
                    ))}
                    ...
                    {/* Center cap */}
                    <mesh rotation={[0, 0, Math.PI / 2]}>
                        <cylinderGeometry args={[0.07, 0.07, 0.23, 16]} />
                        <meshStandardMaterial color="#1a2332" metalness={0.7} roughness={0.3} />
                    </mesh>
                </group>
            ))}

            {/* Professional Headlights - Refined design */}
            {/* Left headlight housing */}
            <mesh position={[-0.34, 0.3, 1.05]} castShadow>
                <RoundedBox args={[0.2, 0.16, 0.08]} radius={0.025} smoothness={4} />
                <primitive object={trimMaterial} attach="material" />
            </mesh>
            {/* Left headlight lens */}
            <mesh position={[-0.34, 0.3, 1.08]} castShadow>
                <RoundedBox args={[0.18, 0.14, 0.02]} radius={0.02} smoothness={4} />
                <meshStandardMaterial 
                    color="#f8fafc" 
                    emissive="#fff8dc" 
            ...
            {/* Left headlight inner bezel */}
            <mesh position={[-0.34, 0.3, 1.07]} castShadow>
                <RoundedBox args={[0.16, 0.12, 0.015]} radius={0.015} smoothness={3} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            ...
            {/* Right headlight inner bezel */}
            <mesh position={[0.34, 0.3, 1.07]} castShadow>
                <RoundedBox args={[0.16, 0.12, 0.015]} radius={0.015} smoothness={3} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            
            {/* Professional fog lights */}
            <mesh position={[-0.24, 0.2, 1.08]} castShadow>
                <RoundedBox args={[0.09, 0.07, 0.018]} radius={0.012} smoothness={3} />
                <meshStandardMaterial 
                    color="#f8fafc" 
                    emissive="#fff8dc" 
            ...
            {/* Professional Taillights - Refined design */}
            {/* Left taillight housing */}
            <mesh position={[-0.38, 0.28, -1.05]} castShadow>
                <RoundedBox args={[0.22, 0.16, 0.08]} radius={0.025} smoothness={4} />
                <primitive object={trimMaterial} attach="material" />
            </mesh>
            {/* Left taillight lens */}
            <mesh position={[-0.38, 0.28, -1.08]} castShadow>
                <RoundedBox args={[0.2, 0.14, 0.02]} radius={0.02} smoothness={4} />
                <meshStandardMaterial 
                    color="#dc2626" 
                    emissive="#ef4444" 
            ...
            {/* Left taillight inner bezel */}
            <mesh position={[-0.38, 0.28, -1.07]} castShadow>
                <RoundedBox args={[0.18, 0.12, 0.015]} radius={0.015} smoothness={3} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            ...
            {/* Right taillight inner bezel */}
            <mesh position={[0.38, 0.28, -1.07]} castShadow>
                <RoundedBox args={[0.18, 0.12, 0.015]} radius={0.015} smoothness={3} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            
            {/* Professional reverse lights */}
            <mesh position={[-0.16, 0.26, -1.08]} castShadow>
                <RoundedBox args={[0.09, 0.07, 0.018]} radius={0.012} smoothness={3} />
                <meshStandardMaterial 
                    color="#f8fafc" 
                    emissive="#ffffff" 
            ...
            {/* SUV roof rails - Prominent design */}
            <mesh position={[-0.48, 0.81, -0.3]} castShadow>
                <RoundedBox args={[0.04, 0.05, 0.9]} radius={0.015} smoothness={3} />
            ...
            {/* Shark fin antenna - Modern SUV feature */}
            <mesh position={[0, 0.83, -0.85]} rotation={[0.2, 0, 0]} castShadow>
                <RoundedBox args={[0.06, 0.08, 0.1]} radius={0.015} smoothness={3} />
                <meshStandardMaterial color={carMetal} metalness={0.7} roughness={0.4} />
            </mesh>
            
            {/* Professional door panel lines - Subtle design detail */}
            <mesh position={[-0.47, 0.32, 0.3]} castShadow>
                <boxGeometry args={[0.004, 0.36, 0.56]} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            <mesh position={[-0.47, 0.32, -0.33]} castShadow>
                <boxGeometry args={[0.004, 0.36, 0.62]} />
                <primitive object={chromeDarkMaterial} attach="material" />
            </mesh>
            <mesh position={[0.47, 0.32, 0.3]} castShadow>
                <boxGeometry args={[0.004, 0.36, 0.56]} />
            ...
            {/* SUV wheel arches/fenders - Prominent cladding */}
            {[
                [-0.51, 0.26, 0.78],
                [0.51, 0.26, 0.78],
                [-0.51, 0.26, -0.78],
                ...
                <mesh key={`fender-${i}`} position={pos as [number, number, number]} castShadow>
                    <RoundedBox args={[0.1, 0.18, 0.3]} radius={0.04} smoothness={4} />
                    <meshStandardMaterial color={carMetal} metalness={0.6} roughness={0.5} />
                </mesh>
            ))}
            ...
            {ZONE_3D_POSITIONS.map(zonePos => {
                ...
                // Color logic: Selected damage areas = red, selected non-damage = amber, hovered = amber, damage = severity color
                const zoneColor = hasDamage && isSelected
                    ? '#ef4444' // Red for selected damage areas
                    : hasDamage
                    ? getSeverityColor(damage.severity)
                    : isSelected
                    ? '#f59e0b' // Amber for selected non-damage areas
                    : isHovered
                    ? '#fbbf24' // Light amber for hovered
                    : '#9ca3af';
                ...
                return (
                    ...
                    >
                        ...
                        <meshStandardMaterial
                            color={zoneColor}
                            opacity={hasDamage && isSelected ? 0.85 : hasDamage ? 0.7 : isSelected ? 0.5 : isHovered ? 0.3 : 0.05}
                            transparent
                            wireframe={!hasDamage && !isSelected}
                            emissive={hasDamage && isSelected ? '#ff0000' : isSelected ? '#f59e0b' : '#000000'}
                            emissiveIntensity={hasDamage && isSelected ? 0.3 : isSelected ? 0.2 : 0}
                        />
                        {hasDamage && damage && (
                            <Html
                                position={[0, zonePos.size[1] / 2 + 0.1, 0]}
                                center
                                style={{ pointerEvents: 'none' }}
                            >
                                <div
...
export default function InteractiveDamageDiagram({
    ...
    const [activeView, setActiveView] = useState<ViewType>('FRT');
    const [damageEntries, setDamageEntries] = useState<DamageEntry[]>(initialDamage);
    const [selectedZone, setSelectedZone] = useState<string | null>(null);
    ...
    const getZonesForView = (
        view: ViewType
    ): Array<{ zoneId: string; metadata: SVCZoneMetadata; zonePath: ZonePath }> => {
        return Object.entries(DEFAULT_ZONE_METADATA)
            .map(([_, metadata]) => {
                const pathKey = `${metadata.zone_id}_${view}`;
                const zonePath = ZONE_PATHS[pathKey];
                if (zonePath && zonePath.view === view) {
                    return { zoneId: metadata.zone_id, metadata, zonePath };
                }
                return null;
            })
    ...
    const handleSaveDamage = async () => {
        ...
        try {
            const existingIndex = damageEntries.findIndex(d => d.zone_id === editingDamage.zone_id);
            let updatedEntries: DamageEntry[];
            ...
            showError(err instanceof Error ? err.message : 'Failed to save damage');
        } finally {
            setSaving(false);
        }
    };
    ...
    const renderVehicleView = (view: ViewType) => {
        ...
        const imageMap: Record<ViewType, string> = {
            ...
            LHS: '/damageDiagram/left.jpg',
            RHS: '/damageDiagram/right.PNG',
            UND: '/damageDiagram/underside.jpg',
            INT: '/damageDiagram/interior.jpg',
        };
        
        const backgroundImage = imageMap[view];
        ...
        return (
            <div className="relative w-full h-64 bg-white rounded-lg overflow-hidden border border-gray-300">
                <svg viewBox="0 0 100 100" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
                    ...
                    {zones.map(({ zoneId, zonePath }) => {
                        const damage = damageEntries.find(d => d.zone_id === zoneId);
                        const isSelected = selectedZone === zoneId;
                        const isHovered = hoveredZone === zoneId;
                        const hasDamage = !!damage;
                        const zoneColor = hasDamage ? '#ef4444' : 'transparent';
                        const bounds = zonePath.bounds || { x: 0, y: 0, width: 0, height: 0 };

                        return (
                            <g key={zoneId} id={zoneId}>
                                <path
                                    d={zonePath.path}
                                    fill={hasDamage ? zoneColor : isHovered || isSelected ? 'rgba(251, 191, 36, 0.1)' : 'transparent'}
                                    fillOpacity={hasDamage ? 0.5 : (isHovered || isSelected) ? 0.2 : 0}
                                    stroke={isSelected ? '#f59e0b' : isHovered ? '#fbbf24' : hasDamage ? '#dc2626' : 'transparent'}
                                    strokeWidth={isSelected ? 2.5 : isHovered ? 2 : hasDamage ? 1.5 : 0}
                                    strokeDasharray={damage?.pre_existing ? '4,2' : '0'}
                                    strokeLinejoin="round"
                                    strokeLinecap="round"
                                    className="cursor-pointer transition-all"
                                    onClick={() => handleZoneClick(zoneId)}
                                    onMouseEnter={() => handleZoneHover(zoneId)}
                                    onMouseLeave={() => handleZoneHover(null)}
                                    style={{ filter: hasDamage && !damage.pre_existing ? 'drop-shadow(0 0 4px #ef4444)' : 'none' }}
                                />
                                {hasDamage && damage && bounds && (
                                    <>
                                        <text
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        <div className="bg-black/30 border border-gray-800 rounded-lg p-6">
                            ...
                            <p className="text-gray-400 text-sm mb-4">
                                Click on vehicle parts to mark damage. Click again to edit or remove.
                            </p>
                            ...
                            {viewMode === '3D' && (
                                <div className="mb-4">
                                    ...
                                    <div className="relative w-full h-96 bg-gray-900 rounded-lg overflow-hidden border border-gray-700">
                                        <Canvas camera={{ position: [2, 1.5, 2], fov: 50 }} gl={{ antialias: true }}>
                                            <Suspense
                                                fallback={
                                                    <Html center>
                                            ...
                                            >
                                                {/* Professional lighting setup for 3D car showcase */}
                                                <ambientLight intensity={0.45} />
                                                <directionalLight position={[6, 9, 6]} intensity={1.4} castShadow color="#ffffff" />
                                                <directionalLight position={[-5, 6, -5]} intensity={0.7} color="#f0f0f0" />
                                                <pointLight position={[0, 7, 0]} intensity={0.5} color="#ffffff" />
                                                <pointLight position={[4, 4, 4]} intensity={0.35} color="#ffffff" />
                                                <pointLight position={[-4, 4, -4]} intensity={0.25} color="#f5f5f5" />
                            ...
                            {viewMode === '2D' && (
                                <>
                                    <div className="flex gap-2 mb-4 flex-wrap">
                                        {(['FRT', 'REA', 'LHS', 'RHS', 'TOP'] as ViewType[]).map(view => (
                                            <button
                                                key={view}
                                                onClick={() => setActiveView(view)}
                                                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                                            ...
                                            >
                                                {view === 'TOP' ? 'Top' : view === 'FRT' ? 'Front' : view === 'REA' ? 'Rear' : view === 'LHS' ? 'Left' : 'Right'}
                                            </button>
                                        ))}
                                    </div>
                                    <div className="mb-4">
                                        <h4 className="text-sm font-medium text-gray-400 mb-2 uppercase">
                                            {activeView === 'TOP' ? 'Top View' : activeView === 'FRT' ? 'Front View' : activeView === 'REA' ? 'Rear View' : activeView === 'LHS' ? 'Left Side' : 'Right Side'}
                                        </h4>
                                        {renderVehicleView(activeView)}
                                    </div>
                                </>
                    ...
                    <div className="space-y-4">
                        <div className="bg-black/30 border border-gray-800 rounded-lg p-6">
                            <div className="flex items-center justify-between mb-4">
                                <h3 className="text-lg font-semibold text-white">Damage Details</h3>
                                {editingDamage && (
                                    <button
                                        onClick={() => {
                                            setEditingDamage(null);
                                ...
                                <div className="mb-4">
                                    <div className="bg-gray-900/50 rounded-lg overflow-hidden border border-gray-800">
                                        <table className="w-full text-sm">
                                            <thead>
                                                <tr className="bg-amber-500/20 border-b border-amber-500/30">
                                                    <th className="px-3 py-2 text-left text-amber-400 font-semibold text-xs">Section</th>
                                                    <th className="px-3 py-2 text-left text-amber-400 font-semibold text-xs">Severity</th>
                                                    <th className="px-3 py-2 text-center text-amber-400 font-semibold text-xs">Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {getDamageTableData().map((damage, idx) => (
                                                    <tr
                                                        key={damage.zone_id}
                                                        className={`border-b border-gray-800/50 hover:bg-gray-900/50 ${idx % 2 === 0 ? 'bg-gray-900/30' : ''}`}
                                                    >
                                                        <td className="px-3 py-2 text-white text-xs">
                                                            {damage.label}
                                                            {damage.pre_existing && (
                                                                <span className="ml-2 text-xs text-gray-500">(Pre-existing)</span>
                                                            )}
                                                        </td>
                                                        <td className="px-3 py-2">
                                                            <span
                                                                ...
                                                                style={{
                                                                    ...
                                                                    borderColor: `${getSeverityColor(damage.severity)}50`,
                                                                }}
                                                            >
                                                                {damage.severity}
                                                            </span>
                                                            ...
                                                            <div className="flex items-center justify-center gap-1">
                                                                <button
                                                                    onClick={() => {
                                                                        ...
                                                                        setSelectedZone(damage.zone_id);
                                                                    }}
                                                                    className="p-1 text-gray-400 hover:text-amber-500 transition-colors"
                                                                    title="Edit"
                                                                >
                                                                ...
                                                                <button
                                                                    onClick={() => handleDeleteDamage(damage.zone_id)}
                                                                    className="p-1 text-gray-400 hover:text-red-500 transition-colors"
                                                                    title="Delete"
                                                                >
                                                                    <X className="w-3 h-3" />
                            ...
                            {editingDamage ? (
                                <div className="space-y-4 bg-gray-900/50 p-4 rounded-lg border border-amber-500/30">
                                    <div>
                                        <label className="text-gray-400 text-sm block mb-1">Damage Section</label>
                                        <p className="text-white font-medium">{editingDamage.label}</p>
                                        <p className="text-gray-500 text-xs mt-1">Category: {editingDamage.category}</p>
                                    </div>
                                    <div>
                                        ...
                                        <select
                                            value={editingDamage.severity}
                                            onChange={e => {
                                                const newSeverity = e.target.value as SeverityCode;
                                                const allowed = getAllowedSeverities(editingDamage.zone_id);
                                                if (allowed.includes(newSeverity)) {
                                                    setEditingDamage({ ...editingDamage, severity: newSeverity });
                                                }
                                            }}
                                            className="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-amber-500"
                                        >
                                            {getAllowedSeverities(editingDamage.zone_id).map(severityCode => {
                                                const severity = SEVERITY_CODES.find(s => s.code === severityCode);
                                                return (
                                                    <option key={severityCode} value={severityCode}>
                                                        {severityCode} - {severity?.label || severityCode}
                                                    </option>
                                                );
                                            })}
                                        </select>
                                    ...
                                    <div>
                                        <label className="text-gray-400 text-sm block mb-1">Comments</label>
                                        <textarea
                                            value={editingDamage.comments || ''}
                                            onChange={e => setEditingDamage({ ...editingDamage, comments: e.target.value })}
                                            rows={3}
                                            className="w-full bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-amber-500 resize-none"
                                            placeholder="Add comments..."
                                        />
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            id="preExisting"
                                            checked={editingDamage.pre_existing}
                                            onChange={e => setEditingDamage({ ...editingDamage, pre_existing: e.target.checked })}
                                            className="w-4 h-4 text-amber-500 bg-gray-700 border-gray-600 rounded focus:ring-amber-500"
                                        />
                                        <label htmlFor="preExisting" className="text-gray-400 text-sm">
                                            Pre-existing damage
                                        </label>
                                    </div>
                                    <button
                                ...
                                <p className="text-gray-500 text-sm text-center py-8">
                                    No damage marked. Click on vehicle parts to add damage.
                                </p>
                            ) : null}
                        </div>
                    </div>
