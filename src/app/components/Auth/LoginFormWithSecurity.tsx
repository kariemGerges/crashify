// =============================================
// FILE: app/components/Auth/LoginFormWithSecurity.tsx
// Enhanced Login Form with CSRF and reCAPTCHA (REQ-127, REQ-132)
// =============================================
...
// reCAPTCHA will be loaded via script tag

export const LoginFormWithSecurity: React.FC<{
    ...
    const executeRecaptcha = async (): Promise<string | null> => {
        if (!RECAPTCHA_SITE_KEY || !recaptchaReady || typeof window === 'undefined') {
            return null;
        }

        const grecaptcha = (window as { grecaptcha?: { execute: (siteKey: string, options: { action: string }) => Promise<string> } }).grecaptcha;
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const result = await api.login(email, password, csrfToken, recaptcha);
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="admin@crashify.com.au"
                                    disabled={loading}
                                    autoComplete="email"
                                />
                            </div>
